    ...
    <!--Tarjetas--> 
      ...
      />
        <div class="p-4 card tarjeta2">         
          <h2 class="mb-5 text-center">Gatito o cachorro de 0 meses a 1 año</h2>
          <p class="card-text2 just">    
            Las mascotas recién nacidas deben tener una revisión médica de forma inicial
            para descartar problemas congénitos y para determinar un calendario para su
            desparasitación, así como el esquema de vacunación necesario para el cachorro o
            gatito. En promedio, después de las primeras aplicaciones, la frecuencia para
            las siguientes vacunas es cada 3 o 4 semanas hasta que llegue a las 16 semanas
            de edad. </p><br>De inicio, los perros deben recibir vacunas contra rabia, moquillo,
            parvovirus y otras enfermedades; mientras que los gatos, vacunas contra rabia,
            moquillo y otras enfermedades, además de pruebas de leucemia felina y virus de
            inmunodeficiencia felina. </p><br> Te compartimos el siguiente video sobre vacunas para
            perros para que tengas una mejor idea de las aplicaciones que necesitan los
            cachorros: </p><br> En esta etapa de tu mascota, el veterinario tendrá que dar
            seguimiento para verificar un adecuado crecimiento y desarrollo, así como
            detectar posibles enfermedades. </p><br> También se deben contemplar las opciones de
            esterilización o castración de las mascotas, se recomienda intervenir antes de
            alcanzar la madurez sexual que se presenta alrededor de los 6 o 9 meses de edad
            aproximadamente, aunque algunos veterinarios promueven hacerlo en edades más
            tempranas. Esto dependerá del tipo y raza de cada mascota. 
          </p>
        </div>
      </div>
    <!-- footer -->
