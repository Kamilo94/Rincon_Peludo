    ...
    <!--Tarjetas--> 
      ...
      />
        <div class="p-4 card tarjeta2">         
          <h2 class="mb-5 text-center ">¿Cómo entrenar a tu perro con señas?</h2>
          <p class="card-text2 just">
            Lo primero que debes hacer es que tu perro asocie un gesto de la mano con una de
            sus palabras de comando. A partir de ahí, hacer que tu perro reaccione solamente
            a la señal de la mano es una cuestión de repetición. </p><br>Por ejemplo, supongamos que
            tu perro ya conoce la asociación entre un comando verbal ("siéntate") y la
            acción que deseas que realice (sentado). A continuación, crea una nueva
            asociación entre una señal de mano desconocida, el comando verbal y la acción
            que ya conoce. Para comenzar, combina el comando verbal con una seña, cuando el
            perro realice la acción correcta, refuerza de inmediato este comportamiento con
            una croqueta o premio. No hay nada mejor como entrenar a tu perro presentando al
            inicio premios deliciosos para ellos. </p><br>Tendrás que repetir esto muchas veces para
            asegurarte de que tu perro entienda la asociación. </p><br>Mientras sigas usando la
            recompensa de comida, elimina gradualmente el comando verbal. Durante un tiempo,
            puedes usar el comando verbal y el gesto de la mano juntos, la mitad del tiempo
            y el gesto de la mano solo la mitad del tiempo. </p><br> Una vez que tu perro reaccione
            de manera confiable al gesto de la mano cuando tenga la comida, retira
            gradualmente el pedazo de comida de la ecuación. Pronto tu perro se sentará, se
            acostará o vendrá a ti con un movimiento de tu mano, y ya sabrás cómo entrenar a
            tu perro sin siquiera decir una palabra.
          </p>
        </div>
      </div>
    <!-- footer -->
