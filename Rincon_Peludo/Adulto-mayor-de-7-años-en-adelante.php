    ...
    <!--Tarjetas--> 
      ...
      />
        <div class="p-4 card tarjeta2">         
          <h2 class="mb-5 text-center">Adulto mayor de 7 años en adelante</h2>
          <p class="card-text2 just">
            Como cualquier otro ser vivo, con el paso de los años verás un deterioro natural
            en la energía y funciones del organismo de tu mascota por lo que las visitas al
            veterinario deberán ser al menos dos veces al año. Las revisiones podrán incluir
            análisis de sangre, orina o heces, así como exámenes físicos completos y las
            vacunas o refuerzos necesarios. La presencia de padecimientos es más frecuente
            en esta etapa de vida, por lo que el veterinario te brindará recomendaciones
            para evitar o, en su caso, tratar adecuadamente a tu mascota para que no se vea
            tan afectada su salud si es que ya cuenta con algún inconveniente.
         </p>
        </div>
      </div>
    <!-- footer -->
