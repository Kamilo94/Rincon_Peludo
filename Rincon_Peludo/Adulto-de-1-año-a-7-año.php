    ...
    <!--Tarjetas--> 
      ...
      />
        <div class=" p-4 card tarjeta2">         
          <h2 class="mb-5 text-center">Adulto de 1 año a 7 año</h2>
          <p class="card-text2 just">
          Como ésta es la etapa de vida más larga de tu mascota, es la misma que se toma
          como referencia para la respuesta genérica de visitar al veterinario al menos
          una vez al año, donde el mismo deberá revisar a tu mascota de pies a cabeza y
          con esto, decidir si es necesario hacer un análisis más profundo sobre algún
          aspecto del organismo de tu perro o gato, o, por el contrario, darte buenas
          noticias y confirmar que tu mascota se encuentra con buena salud.</p><br>Algunas
          vacunas necesitarán refuerzo durante esta etapa, por ejemplo, contra el
          moquillo, parvovirus y la rabia. Aunque la frecuencia también dependerá de las
          regulaciones sanitarias de cada gobierno, pues en algunos lugares hay más
          presencia que en otros. </p><br> Es posible que el veterinario decida hacer otros
          análisis rutinarios como tomar muestras de sangre, de orina o haces. Si se trata
          del segundo caso, el veterinario te pedirá llevar una muestra de tu mascota lo
          más recientes posibles, esto para descartar presencia de parásitos intestinales</p>
          </p>
        </div>
      </div>
    <!-- footer -->
