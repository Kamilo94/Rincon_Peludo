    ...
    <!--Tarjetas--> 
      ...
      />
        <div class="p-4 card tarjeta2">         
          <h2 class="mb-5 text-center">¿Qué cantidad de comida debo darle a mi cachorro?</h2>
          <p class="card-text2 just">
            Alimentar a tu nueva mascota con comida para cachorros de alta calidad ayuda a
            prepararlo para una vida larga y saludable como perro adulto. Sin embargo, esto
            plantea muchas preguntas para los propietarios de cachorros, sobre todo en los
            primerizos. ¿Cuánta comida debería dar a mi cachorro? ¿Cada cuánto debo
            alimentarlo? ¿Qué tipo de comida es mejor? </p><br> Pues respondemos a esas preguntas y
            te compartimos algunos consejos para ayudar a los cachorros y sus dueños a tener
            una buena calidad de vida. </p><br> Qué cantidad de comida debo darle a mi cachorro?
            </p><br>Debido a que los cachorros crecen más rápido de lo que nos damos cuenta, deben
            comenzar a comer una comida para cachorros completa y equilibrada tan pronto
            como se destetan, generalmente entre las seis y ocho semanas de edad. </p><br> La
            cantidad de alimento que necesita tu cachorro depende de cuánto pesará en la
            madurez. Por ejemplo, un Labrador Retriever pesará más en la madurez que un
            Russell Terrier. Entonces, el perro más grande requiere más comida como
            cachorro. </p><br> La siguiente tabla puede ayudarte a determinar la cantidad de comida
            seca que alimenta a tu cachorro. Además de esta referencia, también deberás
            revisar las instrucciones de alimentación específicas en la parte posterior de
            la comida de tu cachorro y consultar con tu veterinario.
          </p>
        </div>
      </div>
    <!-- footer -->
